...
def init_colors():
	...
	curses.init_color(curses.COLOR_GREEN, 109, 655, 5)
	curses.init_color(curses.COLOR_BLUE, 0, 0, 999)

	curses.init_color(curses.COLOR_YELLOW, 999, 999, 0)
	curses.init_color(curses.COLOR_MAGENTA, 999, 0, 999)
	curses.init_color(curses.COLOR_CYAN, 0, 999, 999)
